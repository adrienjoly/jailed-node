...
exports.Plugin = function(url, _interface, options) {
  return new Plugin(new StaticScript(url), _interface, options)
}

exports.DynamicPlugin = function(code, _interface, options) {
  return new Plugin(new DynamicScript(code), _interface, options)
}
